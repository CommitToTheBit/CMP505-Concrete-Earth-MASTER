...
float ClassicNoise::Noise(float x, float y, float z)
{
	...
	float n000 = Dot(m_grad3[gi000], x, y, z);
	float n100 = Dot(m_grad3[gi100], x-1, y, z);
	float n010 = Dot(m_grad3[gi010], x, y-1, z);
	float n110 = Dot(m_grad3[gi110], x-1, y-1, z);
	float n001 = Dot(m_grad3[gi001], x, y, z-1);
	float n101 = Dot(m_grad3[gi101], x-1, y, z-1);
	float n011 = Dot(m_grad3[gi011], x, y-1, z-1);
	float n111 = Dot(m_grad3[gi111], x-1, y-1, z-1);
