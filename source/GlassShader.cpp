...
{
	SetRefractionShaderParameters(context, world, view, projection, culling, time, light, opacity, refractiveIndex, frontFaceCulling, camera, texture, normalTexture, refractionMap);
