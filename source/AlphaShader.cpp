...
bool AlphaShader::SetAlphaShaderParameters(ID3D11DeviceContext* context, DirectX::SimpleMath::Matrix* world, DirectX::SimpleMath::Matrix* view, DirectX::SimpleMath::Matrix* projection, bool culling, float time, float alpha, ID3D11ShaderResourceView* alphaMap)
{
	SetShaderParameters(context, world, view, projection, time, culling);
